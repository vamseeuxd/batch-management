...
@Component({
  selector: 'app-faculty-typeahead',
  templateUrl: './faculty-typeahead.component.html',
  styleUrls: ['./faculty-typeahead.component.scss'],
})
export class FacultyTypeaheadComponent implements OnInit {
